...
Route::get('AdminPanel', [AuthController::class, 'AdminPanel']);
...
Route::get('/get/students', [MainController::class, 'students']);
Route::get('/get/teahers', [MainController::class, 'teachers']);
Route::get('/get/classes', [MainController::class, 'classes']);
